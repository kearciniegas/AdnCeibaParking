...
public class ServiceVigilantTest {
	 ...
	 * private static final Integer CILINDRAJE_MOTO = 550; private static final int
	 * MOTOS_EN_PARQUEADERO = 3;
	 * 
	 * @Mock private VigilantImpl calendarioVigilante;
	 * 
	 * @Mock private RulesParkingImpl reglasEstacionamiento;
	 * 
	 * @Mock private RegistryRepository registryRepository;
	 * 
	 * @InjectMocks private VigilantActivitiesImpl operacionesDelVigilante;
	 * 
	 ...
	 * 
	 * when(reglasEstacionamiento.validarSiHayEspacio(VehicleType.MOTO,
	 * MOTOS_EN_PARQUEADERO)) .thenReturn(Boolean.TRUE); // act Registry
	 * registroAlmacenado = operacionesDelVigilante.registrarEntrada(registry);
	 * 
	 * // assert Assert.assertEquals(PLACA_VEHICULO_SIN_RESTRICCION,
	 * registroAlmacenado.getPlaca()); Assert.assertEquals(VehicleType.MOTO,
	 * registroAlmacenado.getVehicleType()); }
	 */
}
